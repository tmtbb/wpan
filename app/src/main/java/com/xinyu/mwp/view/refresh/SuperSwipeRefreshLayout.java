 ...
 * 被包含的View(RvAdapter,ListView etc.)可跟随手指的滑动而滑动<br>
...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    private RefreshViewHolder mListener;// 下拉刷新listener 上拉加载更多
     ...
     * @param child
     */
    private void setHeaderView(View child) {
        if (child == null) {
            return;
        }
    ...
    private void setFooterView(View child) {
        if (child == null) {
            return;
        }
     ...
     * @param listener
     */
    public void setOnRefreshViewHolder(RefreshViewHolder listener) {
        mListener = listener;
        setHeaderView(mListener.createHeaderView());
        setFooterView(mListener.createFooterView());
    }
    ...
    private void updatePushDistanceListener() {
        if (mListener != null) {
            mListener.onPushDistance(pushDistance);
        }
    }
