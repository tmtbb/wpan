 ...
 * <p>You must use an {@link com.levelupstudio.recyclerview.ExpandableRecyclerView.ExpandableAdapter} instead of a {@link Adapter}
 * and an {@link com.levelupstudio.recyclerview.ExpandableRecyclerView.ExpandableViewHolder} instead of a {@link ViewHolder}.</p>
...
public class ExpandableRecyclerView extends RecyclerViewWithHeader {
	...
	/** {@link ItemAnimator} used for normal operations */
	 ...
	 * Similar to {@link ExpandableListView.OnGroupClickListener}.
	 */
	 ...
	 */
	public static class ExpandableViewHolder extends ViewHolder implements View.OnClickListener {
	...
	public static abstract class ExpandableAdapter<VH extends ExpandableViewHolder, T> extends Adapter<VH> implements ExpandHandler {
		...
		/**
		 * Equivalent of {@link Adapter#getItemViewType(int)} for a child View.
		 * <p/>
		 * Return the view type of the item at {@code groupPosition} for the purposes
		 * of view recycling.
		 * <p/>
		 ...
		 * <p>You must override {@link #getGroupStableId(int)} and {@link #getGroupStableIdPosition(Parcelable)} for this to work properly.</p>
		 */
