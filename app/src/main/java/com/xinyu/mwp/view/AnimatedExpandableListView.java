...
public class AnimatedExpandableListView extends ExpandableListView {
     ...
     *    child views.
     *
     * For animating the collapse of a group is a bit icon_chat_more difficult since we
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public final int getChildTypeCount() {
            // Return 1 icon_chat_more than the childTypeCount to account for DummyView
