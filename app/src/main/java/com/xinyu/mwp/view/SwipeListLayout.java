...
public class SwipeListLayout extends FrameLayout {
    ...
    public static interface OnSwipeChangeListener {
        void onDraging(SwipeListLayout mSwipeLayout);

        void onOpen(SwipeListLayout mSwipeLayout);

        void onClose(SwipeListLayout mSwipeLayout);

        void onStartOpen(SwipeListLayout mSwipeLayout);

        void onStartClose(SwipeListLayout mSwipeLayout);
    ...
    public SwipeListLayout(Context context, AttributeSet attrs, int defStyleAttr) {
