...
public class ForceUpdateDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = LayoutInflater.from(context).inflate(com.qiangxi.checkupdatelibrary.R.layout.checkupdatelibrary_force_update_dialog_layout, null);
        setContentView(view);
        initView();
        initData();
        initEvent();
...
//                System.exit(0);
                MyApplication.getApplication().exitApp(context);
            }
        });
    ...
    private void initView() {
        forceUpdateTitle = (TextView) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.forceUpdateTitle);
        forceUpdateTime = (TextView) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.forceUpdateTime);
        forceUpdateVersion = (TextView) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.forceUpdateVersion);
        forceUpdateSize = (TextView) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.forceUpdateSize);
        forceUpdateDesc = (TextView) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.forceUpdateDesc);
        forceUpdateDescLayout = (LinearLayout) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.forceUpdateDescLayout);
        forceUpdateNetworkState = (TextView) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.forceUpdateNetworkState);
        forceUpdateProgress = (NumberProgressBar) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.forceUpdateProgress);
        exitApp = (Button) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.exitApp);
        forceUpdate = (Button) view.findViewById(com.qiangxi.checkupdatelibrary.R.id.forceUpdate);
    }
