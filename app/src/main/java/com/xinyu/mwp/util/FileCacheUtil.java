...
public class FileCacheUtil {
    ...
    public void copySound(File oldfile, String fileName) {
        copyFile(oldfile, getCacheDir(MyApplication.getApplication(), "sound/") + fileName);
    }

    public void copyImage(File oldfile, String fileName) {
        copyFile(oldfile, getCacheDir(MyApplication.getApplication(), "images/") + fileName);
    }


    public void copyFile(String srcPath, String newPath) {
        copyFile(new File(srcPath), newPath);
    }
