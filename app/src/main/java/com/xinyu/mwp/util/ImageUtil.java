...
//        Random random = new Random();
//        int i = random.nextInt(gifUrls.length - 1);
        return gifUrls[0];
    }

    public final static String[] gifUrls = new String[]{
            "http://ww1.sinaimg.cn/large/dca301e3gw1ekgnbx8lidg20b4069dh6.gif"
    };
