...
import com.xinyu.mwp.configs.CharsetCst;
...
public class StringUtil {
    ...
    public static String intToMoney(int score) {
        String res = null;
        try {
            if (score < 0) {
                score = 0;
            ...
            /*if(score%100 == 0) {
                res = String.format("%d", score/100);
    		} else {
    			res = String.format("%d.%02d", score/100,score%100); 
    		}*/
            res = String.format("%d.%02d", score / 100, score % 100);
        } catch (Exception e) {
            // handle exception
    ...
    public static String scoreTOMoney(String score) {
        String res = null;
        score = getFlterCount(score);

        try {
            int money = Integer.parseInt(score);
            res = intToMoney(money);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return res;
    ...
    public static String floatToMoney(String score) {
        String res = null;
        score = getFlterCount(score);

        try {
            int money = (int) Float.parseFloat(score);
            res = intToMoney(money);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getFlterCount(String count) {
    ...
    public static String getAnonyPhoneNum(String phone) {
        String anonyPhone = "";
        if (phone != null && phone.length() == 11) {
            StringBuilder builder = new StringBuilder();
            builder.append(phone.substring(0, 3)).append("****").append(phone.substring(7, 11));
            anonyPhone = builder.toString();
        }
        return anonyPhone;
    }
...
//			}
    ...
    public static String conventMoneyFormat(double d) {
